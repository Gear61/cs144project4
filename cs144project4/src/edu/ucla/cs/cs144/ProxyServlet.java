...
public class ProxyServlet extends HttpServlet implements Servlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        // your codes here
        String query, test;
        query = request.getParameter("q"); //query is null value if nothing is passed (not "null")
        test = "";
        if (query == null) {
            ...
            //converting the stream we're reading off to a inputstreamreader (inputstream takes in byte by byte while inputstreamreader reads line by line)

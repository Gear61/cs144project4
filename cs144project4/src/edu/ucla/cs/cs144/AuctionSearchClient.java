...
public class AuctionSearchClient
{
	...
	private static final String ENDPOINT_URL = "http://sunflower.cs.ucla.edu:41000/axis2/services/AuctionSearchService";
	private static final String TARGET_NAMESPACE = "http://cs144.cs.ucla.edu";

	@SuppressWarnings("unused")
	public static SearchResult[] basicSearch(String query, int numResultsToSkip, int numResultsToReturn)
	{
		try
		{
	...
	@SuppressWarnings("unused")
	public static SearchResult[] advancedSearch(SearchConstraint[] constraints, int numResultsToSkip, int numResultsToReturn)
	{
		try
		{
			RPCServiceClient rpcClient = new RPCServiceClient();

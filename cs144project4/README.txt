...
We use SSL encryption for (4)->(5), since only this communication includes the user’s credit card information.
...
We set the scale to a constant and then disabled the user-scalable variable to 'no' in our meta statement.
...
Along with Q3, we dynamically checked and set the width of the window to the device's width in our meta statement.
